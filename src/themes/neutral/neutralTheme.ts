 ...
 * Neutral Theme
 *
 * A restrained ink-and-surface spine with a from-scratch OKLCH-derived
 * categorical palette. Hues are placed at evenly-spaced positions on the
 * OKLCH wheel, chosen to keep each color recognizable at every tone (no red
 * drift for orange, no blue drift for purple) and well-separated from its
 * neighbors.
 *
 * Core palette: #ffffff canvas, #f7f9fc body, #0d253d ink, #533afd primary.
 *
...
export const neutralTheme = defineTheme({
  ...
  // Typography: system UI fonts keep the interface native and crisp across
  // platforms. Monospace stays as the platform default for code.
  ...
  tokens: {
    // =========================================================================
    // Core — neutral tonal spine with a restrained blue tint for the app
    // canvas, borders, and primary text.
    // 50:#fafafa 100:#f5f5f5 200:#e5e5e5 300:#d4d4d4 400:#a3a3a3
    // 500:#737373 600:#525252 700:#404040 800:#262626 900:#171717 950:#0a0a0a
    // =========================================================================

    // =========================================================================
    // Backgrounds — Stripe-inspired white surfaces on a cool, almost-white
    // canvas. Borders and spacing create hierarchy instead of heavy cards.
    //
    ...
    //
    // Light mode keeps a quiet minimal ladder (white surfaces on a cool
    // canvas; fine blue-gray borders do most of the grouping):
    //   surface  #ffffff
    //   body     #f7f9fc
    //   card     #ffffff
    //   popover  #ffffff
    //   muted    #f0f4f8
    //
    // The light canvas and borders carry a restrained blue tint so the purple
    // primary feels intentional without turning the dashboard into a bright
    // color field.
    // =========================================================================
    '--color-background-surface': ['#ffffff', '#262626'],
    '--color-background-body': ['#f7f9fc', '#1b1b1b'],
    '--color-background-card': ['#ffffff', '#1b1b1b'],
    '--color-background-popover': ['#ffffff', '#1b1b1b'],
    '--color-background-muted': ['#f0f4f8', '#1b1b1b'],

    // Accent + neutral surface tints (sit alongside backgrounds)
    '--color-accent': ['#533afd', '#ebebeb'],
    '--color-accent-hover': ['#4434d4', '#665efd'],
    '--color-accent-pressed': ['#2e2b8c', '#533afd'],
    '--color-accent-muted': ['#efedff', '#262626'],
    '--color-neutral': ['#f7f9fc', '#FFFFFF1A'],

    // Overlays (modal scrims, hover/pressed tints)
    '--color-overlay': ['#00000080', '#000000CC'],
    '--color-overlay-hover': ['#533afd0D', '#FFFFFF0D'],
    '--color-overlay-pressed': ['#533afd1A', '#FFFFFF1A'],

    // Text
    '--color-text-primary': ['#0d253d', '#fafafa'],
    ...
    '--color-text-secondary': ['#273951', '#a3a3a3'],
    '--color-text-disabled': ['#8da0b5', '#525252'],
    '--color-text-accent': ['#533afd', '#ebebeb'],
    '--color-on-dark': '#ffffff',
    '--color-on-light': '#0d253d',
    // Contrast: primary uses white text in light mode and a dark text stop in
    // dark mode, matching the component contract.
    ...
    // Icon
    '--color-icon-accent': ['#533afd', '#ebebeb'],
    '--color-icon-primary': ['#0d253d', '#fafafa'],
    '--color-icon-secondary': ['#64748d', '#a3a3a3'],
    '--color-icon-disabled': ['#8da0b5', '#525252'],
    ...
    '--color-success': ['#0a7f5a', '#9fe59b'],
    '--color-error': ['#c23b45', '#ffc6c1'],
    '--color-warning': ['#9a6700', '#fdcf4f'],
    '--color-success-muted': ['#eaf8f3', '#84c9803D'],
    '--color-error-muted': ['#fff0f1', '#ff9e973D'],
    '--color-warning-muted': ['#fff7dc', '#deb4333D'],

    // Border
    '--color-border': ['#d9e2ec', '#FFFFFF1A'],
    '--color-border-emphasized': ['#b9c8d8', '#525252'],

    // Effects
    '--color-skeleton': ['#edf1f5', '#525252'],
    '--color-shadow': ['#0d253d12', '#0000004D'],
    ...
    // =========================================================================
    // Radius — soft containers and compact controls, with pill actions handled
    // by the application stylesheet. This keeps buttons expressive without
    // making every surface look like a pill.
    ...
    // Shadows
    //
    // Light mode: barely visible drops; borders and whitespace do most of the
    // grouping so the utility stays quiet instead of looking card-heavy.
    //
    ...
    // =========================================================================
    '--shadow-low':
      '0 1px 2px light-dark(oklch(0 0 0 / 4%), oklch(0 0 0 / 25%)), ' +
      '0 2px 5px light-dark(oklch(0 0 0 / 5%), oklch(0 0 0 / 40%)), ' +
      'inset 0 0 0 1px light-dark(transparent, oklch(1 0 0 / 8%))',
    '--shadow-med':
      '0 2px 4px light-dark(oklch(0 0 0 / 5%), oklch(0 0 0 / 35%)), ' +
      '0 6px 14px light-dark(oklch(0 0 0 / 7%), oklch(0 0 0 / 50%)), ' +
    ...
    '--shadow-inset-hover': 'inset 0px 0px 0px 1px #533afd55',
    '--shadow-inset-selected': 'inset 0px 0px 0px 1px #533afd80',
    '--shadow-inset-success': 'inset 0px 0px 0px 1px #1981004D',
    '--shadow-inset-warning': 'inset 0px 0px 0px 1px #ffce2f4D',
    '--shadow-inset-error': 'inset 0px 0px 0px 1px #e33f4a4D',
  },
